        ...
        public ActionResult CreateOrder(Order order, string FullName, string PhoneNumber, string Address, string City, string District, string Ward)
        {
            ...
            try
            {
                ...
                if (isSuccess)
                {
                    ...
                    nhom10_CosmeticsShop.Ultils.Ultils.SendEmail("Cosmetics Shop", "Đơn hàng #" + currentOrder.Id.ToString(), customerContent.ToString(), user.Email);
                    ...
                    nhom10_CosmeticsShop.Ultils.Ultils.SendEmail("Cosmetics Shop", "Đơn hàng #" + currentOrder.Id.ToString(), adminContent.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
